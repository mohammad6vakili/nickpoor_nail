          ...
          <div className={styles.ertonil}>
            ...
            <div className={styles.prescription}>
              ...
              <div className={styles.prescription_description}>
                <p>
                  برای افرادی که به دلایل ارثی، پوشیدن کفش و جوراب نامناسب ناخن
                  درگوشت فرو رفته و حالت لوله‌ای پیدا می‌کند.علاوه براین
                  ورزش‌هایی مانند (فوتبال، والیبال، بسکتبال، تنیس، باله،
                  سوارکاری، کوهنوردی، بدنسازی و…) باعث تغییر فرم ناخن و فرورفتن
                  ناخن درگوشت می‌شود.در بعضی مواقع شیمی درمانی، تیروئید و دیابت
                  می‌توانند عامل این عارضه باشند.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={styles.ertonil_nails_left}>
            ...
            <div className={styles.ertonil_nails_left_description}>
              <p>
                ...
                شدن و جدا شدن ناخن از بستر شوند و در بعضی مواقع حالت لوله ای شکل
                به ناخن ها دهند.البته مانیکور اشتباه و غیر اصولی به همراه ژلیش
                کردن مداوم، روی ناخن هم می‌تواند این آسیب را به همراه داشته
                باشد.اما ارتونیل روی ناخن دست با صلاحدید پودولوژیست و تشخیص
                ضخامت سیم قابل اجرا می‌باشد.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={styles.section_question}>
        <div className={styles.section_question_right}>
          ...
          <div className={styles.question_description}>
            <p>
              بله، سیم‌های ارتونیل حجم بسیار کمی به اندازه یک میلی متر دارند که
              با ظرافت خاصی روی ناخن نصب می‌شوند به همین علت تداخلی درکارهای
              روزانه مثل: راه رفتن، رانندگی، ورزش و… ایجاد نمی‌کنند.
            </p>
          </div>
        ...
        <div className={styles.ertonil_advantage_left}>
          ...
          <div className={styles.taking_care_description}>
            <p>
              ...
              نمی‌باشد. در این متد درمانی شما هیچگونه دردی را احساس نخواهید کرد.
            </p>
          </div>
        </div>
      </section>
